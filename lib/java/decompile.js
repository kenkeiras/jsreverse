...
require(path.join(lib, "attributes.js"));
require(path.join(lib, "bytecode.js"));
require(path.join(lib, "constant_pool.js"));
require(path.join(lib, "descriptor.js"));
require(path.join(lib, "disassemble.js"));
require(path.join(lib, "fields.js"));
require(path.join(lib, "interfaces.js"));
require(path.join(lib, "methods.js"));
 ...
 *
 */
var javaClass = exports = module.exports = (function (file){
